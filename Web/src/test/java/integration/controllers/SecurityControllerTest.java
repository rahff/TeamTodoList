...
public class SecurityControllerTest extends BaseControllerTest {
  ...
  void createManagerAccount() throws Exception {
    var body = objectMapper.writeValueAsString(new SignupUserRequest("rahff@gmail.com", "Rahff", "12345", "userId", "accountId", "priceId"));
    var expected = objectMapper.writeValueAsString(new CreateAccountResultJson(new JwtAuthenticationJson(new UserJson("userId", "Rahff", "rahff@gmail.com", "MANAGER", "accountId"), "rahff@gmail.com$MANAGER", "rahff@gmail.com$"), "http://fakeUrl.com"));
