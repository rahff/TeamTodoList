...
export const todoListsInitialState: TodoListsView = {
    lists: []
}


export const todoListsFakeState: TodoListsView = {
    lists: [
...
export const todoListsFakeStateAfterDeleteSecond: TodoListsView = {
    lists: [
